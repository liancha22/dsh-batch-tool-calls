...
function apply(ctx, config) {
  ...
  /** 每个会话已经过的步数；只有开了 `reassertEverySteps` 才需要维护。 */
  const stepsSeen = cfg.reassertEverySteps > 0 ? new WeakMap() : undefined
